...
namespace M6
{
    public static class global
    {
        ...
        public static List<기초코드> GetList(string 컬럼명)
        {
            try
            {
                return 코드리스트.Where(u => u.컬럼명 == 컬럼명).ToList();
            }
        ...
        public static string GetCodeValue(string 컬럼명, string 코드명)
        {
            try
            {
                return 코드리스트.FirstOrDefault(u => u.코드명 == 코드명 && u.컬럼명 == 컬럼명).번호.ToString();
            }
            catch (System.Exception)
            {
                return string.Empty;
        ...
        public static string GetCodeName(string 컬럼명, string 번호)
        {
            try
            {
                return 코드리스트.FirstOrDefault(u => u.번호 == 번호).코드명.ToString();
            }
            catch (System.Exception)
            {
                return string.Empty;
